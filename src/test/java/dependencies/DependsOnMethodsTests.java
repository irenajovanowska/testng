...
public class DependsOnMethodsTests {
    ...
    @Test (priority = 1, groups = "env_application")
    public void setUp () {
    ...
    @Test (priority = 3, dependsOnMethods = "testOpenApplication")
    ...
    @Test (priority = 4, dependsOnMethods = "testSignIn")
    ...
    @Test (priority = 5, dependsOnMethods = {"testOpenApplication", "testSignIn"})
    ...
    @Test (priority = 6, dependsOnMethods = {"testOpenApplication", "testSignIn"})
    ...
    @Test (priority = 7, dependsOnMethods = {"testOpenApplication", "testSignIn"})
